...
export let colors = ["rgba(255, 217, 0, 1)", "rgba(104, 240, 255, 1)"];
/*
...
export const info = {
    ...
    miniBio: [ // these are just some "tidbits" about yourself. You can look at mine https://paytonjewell.github.io/#/ for an example if you'd like
        ...
        {
            emoji: "💼",
            text: "Master of Computing student at Curtin Uni"
        },
        {
            emoji: "📧",
            text: "eblee.dev@gmail.com"
        }
    ],
    socials: [
        {
        ...
        {
            link: "https://www.linkedin.com/in/eunbee-lee-905238220/",
            icon: "fa fa-linkedin",
            label: 'linkedin'
        }
